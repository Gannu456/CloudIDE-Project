  ...
  return (
    <div>
      ...
      <div className="flex-1 flex">
        {/* Left Side - Visual */}
        <div className="hidden lg:flex w-1/2 bg-gray-50 p-8 items-center justify-center">
          <div className="max-w-md rounded-xl overflow-hidden shadow-lg border border-gray-200">
            <img
            ...
            <div className="p-6 bg-white">
              ...
              <p className="text-gray-600">Continue your coding journey with access to all your projects and teams</p>
            </div>
          </div>
        </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="mt-1 relative">
                    ...
                    >
                      {showPassword ? (
                        <i className="fas fa-eye-slash text-gray-400 hover:text-gray-500" />
                      ) : (
                        <i className="fas fa-eye text-gray-400 hover:text-gray-500" />
                      )}
                    </button>
