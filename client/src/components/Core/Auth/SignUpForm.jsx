        ...
        <div className="hidden lg:flex w-1/2 bg-gray-50 p-8 items-center justify-center">
          <div className="max-w-md rounded-xl overflow-hidden shadow-lg border border-gray-200">
            ...
            <div className="p-6 bg-white">
              <h3 className="text-xl font-bold text-gray-800 mb-2">Build Together in Real-Time</h3>
              <p className="text-gray-600">Join thousands of developers creating amazing projects with our collaborative platform</p>
            </div>
          </div>
        </div>
