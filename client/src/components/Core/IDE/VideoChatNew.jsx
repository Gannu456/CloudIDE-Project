...
const VideoChatNew = ({ roomId, onLeave, initialUserName }) => {
  ...
  return (
    ...
    //             <FaUserFriends /> {users.length} participant
    //             {users.length !== 1 ? "s" : ""}
    //           </span>
    //         )}
    //       </div>
    ...
    //           <button onClick={updateUserName} className="confirm-btn">
    //             <FaCheck /> Confirm
    //           </button>
    //           <button
    //             onClick={() => {
    ...
    //           !localMediaState.video && !isScreenSharing ? "video-muted" : ""
    //         }`}
    //       >
    //         <video
    //           ref={localVideoRef}
    ...
    //         />
    //         {isScreenSharing && (
    //           <div className="screen-share-indicator">Screen Sharing</div>
    //         )}
    //         {!localMediaState.video && !isScreenSharing && (
    ...
    //                 !user.video && !user.screen ? "video-muted" : ""
    //               } ${user.screen ? "screen-share" : ""}`}
    //             >
    //               <video
    //                 autoPlay
    //                 playsInline
    ...
    //               />
    //               {user.screen && (
    //                 <div className="screen-share-indicator">Screen Share</div>
    //               )}
    //               {!user.video && !user.screen && (
    //                 <div className="video-muted-overlay">Camera Off</div>
    //               )}
    ...
    //                 {user.name}
    //                 {!user.audio && (
    //                   <span className="audio-muted-indicator"> (Muted)</span>
    //                 )}
    //               </div>
    //             </div>
    //           ))}
    ...
    //       <button
    //         onClick={toggleAudio}
    //         className={`control-btn ${!localMediaState.audio ? "active" : ""}`}
    //         title={
    //           localMediaState.audio ? "Mute microphone" : "Unmute microphone"
    //         }
    //       >
    //         {localMediaState.audio ? <FaMicrophone /> : <FaMicrophoneSlash />}
    ...
    //       <button
    //         onClick={toggleVideo}
    //         className={`control-btn ${!localMediaState.video ? "active" : ""}`}
    //         title={localMediaState.video ? "Turn off camera" : "Turn on camera"}
    //       >
    //         {localMediaState.video ? <FaVideo /> : <FaVideoSlash />}
    //         <span className="control-label">
    //           {localMediaState.video ? "Stop Video" : "Start Video"}
    //         </span>
    //       </button>
